%% TiltRotor Dynamic model - Complex version including gyroscopic effects

% Questa versione tiene conto degli effetto gyros e inerziali del singolo
% braccio, according to the paper "novel overactuaded tilt bla bla bal"
...
tau_1 = [ 0; 0; -Kq*omega_1^2];            % There is '-' sign since the drag torque is CCW
tau_2 = [ 0; 0; Kq*omega_2^2];
tau_3 = [ 0; 0; -Kq*omega_3^2];            % There is '-' sign since the drag torque is CCW
tau_4 = [ 0; 0; Kq*omega_4^2];

syms p q r real;
omega_b = [p;q;r];

syms alphad_1 alphad_2 alphad_3 alphad_4 real                   % Tilting velocity about XPi axes

% Inertia matrix of a rotating disk 
% Izd = m_d*r_d^2/2;
% Ixd = m_d*r_d^2/4;
% Iyd = Ixd;
syms Ixd Izd Iyd real;
...
for i=1:n_rotors
    ...
    switch i
        case 1
           ...
           F_1 = R_BPi_axis*T_p1
           Op1 = R_z_axis * [ b; 0 ; 0];
           % the next two lines are added to introduce gyroscopic effect
           %  in the resistant force tau
           omega_P1 =  R_BPi_axis'*omega_b + [alphad_1 ; 0 ; omega_1]      % Angular velocity of the 1th propeller group, expressed in Fpi
           tau_d1   = cross(omega_P1,In_Pi*omega_P1) - tau_1;                %this is the overal tau
        ...
        case 2
           ...
           omega_P2 =  R_BPi_axis'*omega_b + [alphad_2 ; 0 ; omega_2]      % Angular velocity of the 1th propeller group, expressed in Fpi
           tau_d2   = cross(omega_P2,In_Pi*omega_P2) - tau_2;                %this is the overal tau
        ...
        case 3
           ...
           omega_P3 =  R_BPi_axis'*omega_b + [alphad_3 ; 0 ; omega_3]      % Angular velocity of the 1th propeller group, expressed in Fpi
           tau_d3   = cross(omega_P3,In_Pi*omega_P3) - tau_3;                %this is the overal tau
        ...
        case 4
           ...
           omega_P4 =  R_BPi_axis'*omega_b + [alphad_4 ; 0 ; omega_4]      % Angular velocity of the 1th propeller group, expressed in Fpi
           tau_d4   = cross(omega_P4,In_Pi*omega_P4) - tau_4;                %this is the overal tau
