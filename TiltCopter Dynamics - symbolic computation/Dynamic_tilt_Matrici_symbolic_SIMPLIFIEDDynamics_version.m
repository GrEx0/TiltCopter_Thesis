%% TiltRotor Dynamic model - Simplified version
% Questa versione trascura gli effetti giroscopici e inerziali della rotazione del
% braccio.
% Tramite questo script è possibile ricavare la mixer matrix linearizzata e
% la mixer matrix "non lineare".
