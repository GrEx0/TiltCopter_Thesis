 ...
 * C++ source code generated on : Wed Aug 31 17:12:54 2016
 *
...
void Traslational_controllerModelClass::step()
{
   ...
   *  Inport: '<Root>/u_des'
   */
  rtb_Sum4 = Traslational_controller_P.Gain2_Gain *
    Traslational_controller_U.u_des;

  /* Saturate: '<S1>/Saturation' */
  if (rtb_Sum4 > Traslational_controller_P.Saturation_UpperSat) {
    rtb_Sum4 = Traslational_controller_P.Saturation_UpperSat;
  } else {
    if (rtb_Sum4 < Traslational_controller_P.Saturation_LowerSat) {
      rtb_Sum4 = Traslational_controller_P.Saturation_LowerSat;
    }
  }
   ...
   *  Saturate: '<S1>/Saturation'
   */
  rtb_Sum4 = Traslational_controller_P.umax * rtb_Sum4 -
  ...
  Traslational_controller_B.FilterCoefficient = (Traslational_controller_P.Kd_u *
    rtb_Sum4 - Traslational_controller_X.Filter_CSTATE) *
   ...
   *  Sum: '<S2>/Sum'
   */
  Traslational_controller_Y.Fx = (Traslational_controller_P.Kp_u * rtb_Sum4 +
    Traslational_controller_X.Integrator_CSTATE) +
  ...
  if (Traslational_controller_U.v_des >
    ...
    rtb_Sum1 = Traslational_controller_P.Saturation1_UpperSat;
  } else if (Traslational_controller_U.v_des <
             Traslational_controller_P.Saturation1_LowerSat) {
    rtb_Sum1 = Traslational_controller_P.Saturation1_LowerSat;
  } else {
    rtb_Sum1 = Traslational_controller_U.v_des;
  }
   ...
   */
  rtb_Sum1 = Traslational_controller_P.vmax * rtb_Sum1 -
  ...
  Traslational_controller_B.FilterCoefficient_m =
    (Traslational_controller_P.Kd_v * rtb_Sum1 -
   ...
   *  Sum: '<S3>/Sum'
   */
  Traslational_controller_Y.Fy = (Traslational_controller_P.Kp_v * rtb_Sum1 +
    Traslational_controller_X.Integrator_CSTATE_c) +
    Traslational_controller_B.FilterCoefficient_m;

  /* Gain: '<S2>/Integral Gain' */
  Traslational_controller_B.IntegralGain = Traslational_controller_P.Ki_u *
    rtb_Sum4;

  /* Gain: '<S3>/Integral Gain' */
  Traslational_controller_B.IntegralGain_j = Traslational_controller_P.Ki_v *
    rtb_Sum1;
  if (rtmIsMajorTimeStep((&Traslational_controller_M))) {
...
void Traslational_controllerModelClass::Traslational_controller_derivatives()
{
  ...
  _rtXdot->Integrator_CSTATE = Traslational_controller_B.IntegralGain;

  /* Derivatives for Integrator: '<S2>/Filter' */
  _rtXdot->Filter_CSTATE = Traslational_controller_B.FilterCoefficient;

  /* Derivatives for Integrator: '<S3>/Integrator' */
  _rtXdot->Integrator_CSTATE_c = Traslational_controller_B.IntegralGain_j;
...
void Traslational_controllerModelClass::initialize()
{
  ...
  Traslational_controller_X.Integrator_CSTATE =
    Traslational_controller_P.Integrator_IC;
  ...
  Traslational_controller_X.Integrator_CSTATE_c =
    Traslational_controller_P.Integrator_IC_d;
